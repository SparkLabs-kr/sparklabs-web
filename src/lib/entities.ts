...
export interface EntityMeta {
  ...
  /** Spark accent — only the 4 logo colors, cycled in display order (orange → pink → blue → green) */
  accent: 'orange' | 'pink' | 'blue' | 'green';
  /** One-line description for the home network list */
...
export const entities: EntityMeta[] = [
  {
    ...
    accent: 'orange',
    tagline: {
      ko: '플래그십 배치 프로그램과 AI-First 초기 투자',
      en: 'Flagship batch program and AI-first seed investment',
    },
    focus: {
  ...
  },
  {
    ...
    accent: 'pink',
    tagline: {
      ko: '그룹 전체를 아우르는 액셀러레이터 네트워크',
      en: 'The master entity orchestrating the global network',
    },
    focus: {
  ...
  },
  {
    ...
    accent: 'blue',
    tagline: {
      ko: '대만·동남아 시장의 테크 스타트업 육성',
      en: 'Backing tech startups across Taiwan and Southeast Asia',
    },
    focus: {
  ...
  },
  {
    ...
    accent: 'green',
    tagline: {
      ko: '중동 스타트업 생태계와의 전략적 브릿지',
      en: 'A strategic bridge to the MENA startup ecosystem',
    },
    focus: {
  ...
  },
  {
    ...
    accent: 'orange',
    tagline: {
      ko: '애그테크·푸드테크 특화 액셀러레이터',
      en: 'Agrifood and sustainability accelerator for ANZ',
    },
    focus: {
  ...
  },
  {
    ...
    accent: 'pink',
    tagline: {
      ko: '바이오·헬스케어 특화 액셀러레이터',
      en: 'Dedicated bio and healthcare accelerator',
    },
    focus: {
  ...
  },
  {
    ...
    accent: 'blue',
    tagline: {
      ko: '지역 거점 확장과 산업 클러스터 연계',
      en: 'Regional hubs and industry cluster linkage',
    },
    focus: {
